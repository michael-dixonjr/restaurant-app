...
import ReservationStyles from  '../components/styles/Reservationpage.module.css';
...
export default function Reservationpage() {
    ...
    const onSubmitHandler = (event) => {
        ...
        if(isValid) {
            const dateTime = new Date(formData.date).toLocaleString();
            alert(`Your table is booked! We will see you @ ${dateTime}`);
            event.target.reset();
        }
    };

    return (
        <div className={ReservationStyles.page_wrapper}>
            <div className="res-content-container">
                <section className={ReservationStyles.hero_container}>
                    <div className={ReservationStyles.hero_content}>
                ...
                <div className={ReservationStyles.form_container}>
                    <h1>Reserve a Table</h1>
                    <p>Please fill in and submit form to book your reservation at Little Lemon.</p>
                    <form className={ReservationStyles.reservation_form} onSubmit={onSubmitHandler}>
                        <fieldset>
                            <div className="field">
